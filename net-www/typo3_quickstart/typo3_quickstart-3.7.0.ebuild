...
SRC_URI="http://typo3.sunsite.dk/unix-archives/${PV}/quickstart/${MY_PN}-${PV}.tar.gz"
...
pkg_postinst(){
	...
	einfo "For example:"
	einfo "webapp-config -I typo3_quickstart 3.7.0 --virtual-dirs server-owned --virtual-files server-owned -d <directory>"
