...
SRC_URI="http://typo3.sunsite.dk/unix-archives/${PV}/dummy/${MY_PN}-${PV}.tar.gz"
...
pkg_postinst(){
	...
	einfo "For example:"
	einfo "webapp-config -I typo3_dummy 3.6.2 --virtual-dirs server-owned --virtual-files server-owned -d <directory>"
