...
src_install() {
	...
	webapp_src_install
	webapp_hook_script ${FILESDIR}/typo3_generate_symlinks.sh
}

pkg_postinst() {
	einfo "  *** NOTE typo3_testsite ***"
	...
	einfo "For example:"
	einfo "webapp-config -I typo3_testsite ${PV} --virtual-dirs server-owned --virtual-files server-owned -d <directory>"
